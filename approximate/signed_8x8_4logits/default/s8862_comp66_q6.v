...
LUT6_2 #(
    ...
    .I0(c_row[1]), .I1(b_row[1]), .I2(a_row[1]), .I3(g[0]),
    .I4(1'b1), .I5(1'b1),
    .O5(g[1]), .O6(p[1])
);
...
LUT6_2 #(
    ...
    .I0(c_row[2]), .I1(b_row[2]), .I2(a_row[2]), .I3(g[1]),
    .I4(1'b1), .I5(1'b1),
    .O5(g[2]), .O6(p[2])
);
...
LUT6_2 #(
    ...
    .I0(c_row[3]), .I1(b_row[3]), .I2(a_row[3]), .I3(g[2]),
    .I4(1'b1), .I5(1'b1),
    .O5(g[3]), .O6(p[3])
);
...
LUT6_2 #(
    ...
    .I0(c_row[4]), .I1(b_row[4]), .I2(a_row[4]), .I3(g[3]),
    .I4(1'b1), .I5(1'b1),
    .O5(g[4]), .O6(p[4])
);
...
LUT6_2 #(
    ...
    .I0(c_row[5]), .I1(b_row[5]), .I2(a_row[5]), .I3(g[4]),
    .I4(1'b1), .I5(1'b1),
    .O5(g[5]), .O6(p[5])
);
